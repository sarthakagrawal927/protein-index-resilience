/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2ece7ac4b5df5e2a3f1bf7b9898ab2f6)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_HEALTH_INGEST_KEY">> {}
}
